...
public class TravelCalculatorController {
	...
	@RequestMapping(value="/alienTravelCalculatorInput", method=RequestMethod.GET)
	public String displayTravelCalculatorInputPage(Model modelHolder) {
		modelHolder.addAttribute("planets", getPlanets());
		return "alienTravelCalculatorInput";
	}
	
	@RequestMapping(value="/alienTravelCalculatorResult", method=RequestMethod.GET)
	public String displayTravelCalculatorResultPage(Model modelHolder, @RequestParam String planetName, @RequestParam String transportation, @RequestParam int earthAge) {
		TravelCalculator calculator = new TravelCalculator(planetName, transportation, earthAge, getPlanets());
