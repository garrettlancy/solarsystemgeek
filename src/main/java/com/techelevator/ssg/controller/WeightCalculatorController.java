...
public class WeightCalculatorController {
	...
	@RequestMapping(value="/alienWeightCalculatorInput", method=RequestMethod.GET)
	public String displayWeightCalculatorInputPage(Model modelHolder) {
		modelHolder.addAttribute("planets", getPlanets());
		return "alienWeightCalculatorInput";
	}
	
	@RequestMapping(value="/alienWeightCalculatorResult", method=RequestMethod.GET)
	public String displayWeightCalculatorResultPage(Model modelHolder, @RequestParam String planetName, @RequestParam int earthWeight) {
		WeightCalculator calculator = new WeightCalculator(planetName, earthWeight, getPlanets());
