...
<body>
    ...
    <nav>
    	<c:url value="/alienWeightCalculatorInput" var="alienWeightCalculatorInput" />
    	<c:url value="/alienAgeCalculatorInput" var="alienAgeCalculatorInput" />
    	<c:url value="/alienTravelCalculatorInput" var="alienTravelCalculatorInput" />
    	<c:url value="/spaceForumDisplay" var="spaceForumDisplay" />
    	<c:url value="/shoppingCart/index" var="spaceShopDisplay" />
    	
        <h2>Explore The Solar System</h2>
        <p> Use these state of the art web applications to learn more about the solar system! </p>
        <ul>
            <li><a href="${alienAgeCalculatorInput}">Alien Age</a></li>
            <li><a href="${alienWeightCalculatorInput}">Alien Weight</a></li>
            <li><a href="${alienTravelCalculatorInput}">Drive Time</a></li> 
            <li><a href="${spaceForumDisplay}">Space Forum</a></li>
            <li><a href="${spaceShopDisplay}">Space Store</a></li>             
